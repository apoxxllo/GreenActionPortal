...
using GreenActionPortal.Configuration;

namespace GreenActionPortal.Authentication
{
    /// <summary>
    /// SignInManager
    /// </summary>
    public class SignInManager
    {
        ...
        public ClaimsIdentity CreateClaimsIdentity(User user)
        {
            ...
            {
                new Claim(ClaimTypes.NameIdentifier, userId, ClaimValueTypes.String, "greenactionportal"),
                new Claim(ClaimTypes.Name, name, ClaimValueTypes.String, "greenactionportal"),
                new Claim(ClaimTypes.Role, user.Position.PositionName, ClaimValueTypes.String, "greenactionportal"),

                new Claim("UserId", userId, ClaimValueTypes.String, "greenactionportal"),
                new Claim("UserName", name, ClaimValueTypes.String, "greenactionportal"),
                new Claim("Position", user.Position.PositionName, ClaimValueTypes.String, "greenactionportal"),
                new Claim("ProfilePictureUrl", user.ProfilePicPath, ClaimValueTypes.String, "greenactionportal") // This is important
